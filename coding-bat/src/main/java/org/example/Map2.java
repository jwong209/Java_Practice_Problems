...
//        System.out.println("wordMultiple: " + wordMultiple(new String[]{"c", "c", "c", "c"}));
        ...
        System.out.println("allSwap: " + Arrays.toString(allSwap(new String[]{"ab", "ac"})));
        System.out.println("allSwap: " + Arrays.toString(allSwap(new String[]{"ax", "bx", "cx", "cy", "by", "ay", "aaa", "azz"})));
        System.out.println("allSwap: " + Arrays.toString(allSwap(new String[]{"ax", "bx", "ay", "by", "ai", "aj", "bx", "by"})));
